...
pattern_injetada_cons = r'(?:Energia Injetada kWh - TUSD kWh|Energia Injetada GD kWh -TUSD kWh) (\d+)'
# Define o caminho da pasta contendo os arquivos PDF
pasta_contendo_pdfs = "/Users/carloscarvalho/Library/Mobile Documents/com~apple~CloudDocs/BKP/solar/contas de Luz UCs/SET23"
